...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 px-4 sm:px-6 md:px-12 lg:px-24">
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-4">
                    ...
                    <div className="flex gap-4">
                      ...
                      <a href="#" className="text-muted-foreground hover:text-foreground transition-colors" aria-label="Google Scholar">
